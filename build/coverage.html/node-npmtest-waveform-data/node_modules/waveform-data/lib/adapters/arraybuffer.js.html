...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-waveform-data/node_modules/waveform-data/lib/adapters/arraybuffer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-waveform-data/node_modules/waveform-data/lib/adapters/arraybuffer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-waveform-data/node_modules/waveform-data/lib/adapters/</a> &#187; arraybuffer.js</div>
</div>
<div class="body">
 ...
 * @constructor
 */
var WaveformDataArrayBufferAdapter = module.exports = <span class="fstat-no" title="function not covered" >function WaveformDataArrayBufferAdapter(response_data){</span>
 ...
 * @returns {boolean}
 */
WaveformDataArrayBufferAdapter.isCompatible = <span class="fstat-no" title="function not covered" >function isCompatible(data){</span>
<span class="cstat-no" title="statement not covered" >  return data &amp;&amp; typeof data === "object" &amp;&amp; "byteLength" in data;</span>
};
&nbsp;
/**
 ...
 */
WaveformDataArrayBufferAdapter.fromResponseData = <span class="fstat-no" title="function not covered" >function fromArrayBufferResponseData(response_data){</span>
<span class="cstat-no" title="statement not covered" >  return new WaveformDataArrayBufferAdapter(new DataView(response_data));</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >    return Math.round(this.data.getInt8(20 + index));</span>
  }
};
&nbsp;
&nbsp;</pre></td></tr>

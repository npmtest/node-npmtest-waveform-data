...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-waveform-data/node_modules/waveform-data/lib/builders/webaudio.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-waveform-data/node_modules/waveform-data/lib/builders/webaudio.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-waveform-data/node_modules/waveform-data/lib/builders/</a> &#187; webaudio.js</div>
</div>
<div class="body">
 ...
 * @constructor
 */
<span class="fstat-no" title="function not covered" >function fromAudioObjectBuilder(audio_context, raw_response, options, callback){</span>
<span class="cstat-no" title="statement not covered" >  var audioContext = window.AudioContext || window.webkitAudioContext;</span>
<span class="cstat-no" title="statement not covered" >  var defaultOptions = {</span>
    scale: 512,
    amplitude_scale: 1.0
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  if ((audio_context instanceof audioContext) === false) {</span>
<span class="cstat-no" title="statement not covered" >    throw new TypeError('First argument should be an instance of window.AudioContext');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  options.scale = options.scale || defaultOptions.scale;</span>
<span class="cstat-no" title="statement not covered" >  options.amplitude_scale = options.amplitude_scale || defaultOptions.amplitude_scale;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (options.hasOwnProperty('scale_adjuster')) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error("Please rename the 'scale_adjuster' option to 'amplitude_scale'");</span>
  }
&nbsp;
  /*
   ...
   */
<span class="cstat-no" title="statement not covered" >  return audio_context.decodeAudioData(</span>
    raw_response,

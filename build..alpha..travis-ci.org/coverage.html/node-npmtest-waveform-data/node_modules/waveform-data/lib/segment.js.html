...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-waveform-data/node_modules/waveform-data/lib/segment.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-waveform-data/node_modules/waveform-data/lib/segment.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-waveform-data/node_modules/waveform-data/lib/</a> &#187; segment.js</div>
</div>
<div class="body">
 ...
 * @constructor
 */
var WaveformDataSegment = module.exports = <span class="fstat-no" title="function not covered" >function WaveformDataSegment(context, start, end){</span>
...
WaveformDataSegment.prototype = {
   ...
   */
  get offset_start(){
    if (this.start &lt; this.context.offset_start &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.end &gt; this.context.offset_start)</span>{
<span class="cstat-no" title="statement not covered" >      return this.context.offset_start;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.start &gt;= this.context.offset_start &amp;&amp; this.start &lt; this.context.offset_end){</span>
...
<span class="cstat-no" title="statement not covered" >    return null;</span>
   ...
   */
  get offset_end(){
    if (this.end &gt; this.context.offset_start &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.end &lt;= this.context.offset_end)</span>{
<span class="cstat-no" title="statement not covered" >      return this.end;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.end &gt; this.context.offset_end &amp;&amp; this.start &lt; this.context.offset_end){</span>
<span class="cstat-no" title="statement not covered" >      return this.context.offset_end;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return null;</span>
  },
   ...
   */
  get visible(){
    return this.context.in_offset(this.start) || <span class="branch-1 cbranch-no" title="branch not covered" >this.context.in_offset(this.end) </span>|| (<span class="branch-2 cbranch-no" title="branch not covered" >this.context.offset_start &gt; this.start </span>&amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >this.context.offset_start &lt; this.end)</span>;
  },
  /**
